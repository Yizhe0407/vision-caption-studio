...
import { TagKeyController } from "@/src/controllers/tag-key.controller";
...
class AppContainer {
  ...
  readonly tagKeyRepository = new TagKeyRepository();
  ...
  readonly tagKeyService = new TagKeyService(this.tagKeyRepository);
  ...
  readonly tagKeyController = new TagKeyController(this.tagKeyService);
}
